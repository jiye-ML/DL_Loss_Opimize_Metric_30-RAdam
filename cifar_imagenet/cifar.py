...
# writer = SummaryWriter(logdir='./cps/gadam/log_cifar100/')
...
parser.add_argument('--optimizer', default='radam', type=str, choices=['adamw', 'radam', 'sgd'])
parser.add_argument('--lr', '--learning-rate', default=0.01, type=float, metavar='LR', help='initial learning rate')
parser.add_argument('--beta1', default=0.9, type=float, help='beta1 for adam')
parser.add_argument('--beta2', default=0.999, type=float, help='beta2 for adam')
parser.add_argument('--warmup', default=0, type=float, help='warmup steps for adam')
